...
<!-- Page Title Section-->
  ...
  <div id="ct-chapt-graphic">
   <!-- <div class="ct-chapter-quote">
      “Another world is being born right in front of our eyes:  a whole new spirit in the way we think, hope and fear.  The ecological anguish that gives its color to this new age announces nothing less for our civilization than all-encompassing change... Now it is time to take green seriously.”
    </div>
    <div class="ct-quote-source">
     ― Régis Debray, The Green Age: A Change of Civilizations<a name="2-up"><a href="#2-down">²</a></a>
    </div>-->
  </div>
