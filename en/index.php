...
<!-- The flexible grid (content) -->
	<div id="row">
		...
		<div id="main">
            ...
            <div class="lead-text">
            As we become more and more aware of the ecological crises triggered by our modern age, we long to 'go green'.  However, what exactly should green mean and and what should it require?  Inspired by magnificent creatures, ancient cultures and our planet's pattern the <i>Tractatus Ayyew</i> lays out an ethics anchored in Earth's example.
            </div>
