...
<!-- The flexible grid (content) -->
	<div id="row">
        <div id="side">
            ...
            <div class="welcome-to">Welcome to the <span style="cursor:pointer; text-decoration:underline;" onclick="openEarthbook()">EarthBook</span> edition of the <i>Tractatus Ayyew: An Earthen Ethics</i>.</div>
