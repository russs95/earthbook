...
<div class="page-paragraph">
    ...
    <p>Alas, while our telling will never acheive such a magnificence of medium, we've nonetheless put great care into our book's presentation and publication.  Consequently, the <i>Tractatus Ayyew</i> is published as an <button type="button" class="java-link" onclick="openEarthbook()" style="border:none;" aria-label="Open" title="Learn more about what an Earthbook is"><i>Earthbook</i></button>—  an Earth and reader friendly format that embodies the principles of Earthen ethics that we'll be developing in the chapters ahead.</p>
