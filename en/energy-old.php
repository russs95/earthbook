...
dynamic transfer of energy into and out of non-­equilibrium states is what has allowed the earth to emerge, persist, and distinguish itself from other aspects of the cosmos.' Thomas Nail, A Theory of the Earth, (Standford University Press, 2021) Chap.1 p.21" onclick="openFootnotes()">⁶⁰</a></p>-->
     ...
     <p id="61-up">Just as Earth’s absorption of solar energy powers the planet's processes, the salmon’s steady absorbtion of nutrient energy powers its life processes. For just as Earth spun its energy out to the planet's biosphere, so too did the Salmon enrich the biome of which it was part.  Indeed, it seems that over time the Salmon's cycle evolved to maximize the amount of surplus enery shared, and minimize that which they held.</p>
     
     <p>This pattern is most clearly seen in simple terms of biomass.</p>
     ...
     <p id="63-up">This relentless pattern of disperal, not only contribute to a common home for many creatures to thrive, the spiral ever improved the conditions for the Salmon’s own subsequent generations.  <a href="#footnotes" title="Thomas P. Quinn, The Behavior and Ecology of Pacific Salmon and Trout, Second Edition (University of Washington Press,
