...
-->
<div class="lead-page-paragraph" id="p1">
...
<div class="page-paragraph">
  ...
  That said, we are grateful to our invisible beginnings: our ancestors, both of our own lineages and those of other kincentric cultures around the world that have touched and inspired our struggle with the meaning of green. Their accumulated wisdom serves as the bedrock upon which we have built. 
    ...
    <p id="p3">Along our journey, countless friends, family and colleagues who have been of invaluable assistance in our undertaking.</p>

    <p id="p4">Thank you to Pi Villaraza who was instrumental in energizing our early connection and collaboration.  He pointed us towards the use of Igorot and Filipino wisdom traditions to both undergird our work with plastic and to guide the social spread that followed.</p>

    <p id="p5">Un grand merci to Fabrice Garrigues for his dedication and efforts in the French translation of the Tractatus Ayyew and for rich evenings of family, wine and philosophy that accompanied it. Thanks to George Beurnier for his dinners that supplemented our efforts, and for his friendship and encouragement in the quest towards plastic’s resolve—  and billiard excellency.</p>

    <p id="p6">Un grand merci a les deux Frère Jacques de l'Abbey de Scourmont.  First, thank you to Frère Jacques senior for his gift of th Laudato si' encyclical (of which the concept of a "common home" helped to inspire and guide our work) and to his heartwarming persistence acquiring an early version of our French translation without our knowing!  Thank you to Frère Jacques junior for his early review and sourcing Catholic feedback and critic so that we could ensure our work resonates with the Laudato si' movement.</p>
       
    <p id="p7">Thank you to Trisha for her support, encouragement, listening and friendship. Thank you to Shiloh Vermaack and Richard Goldsmith for the relentless reviews of every chapter, not once but twice and sometimes thrice.  Thank you to Nicole and Vaughn for the in-depth reading and encouragement.  Thank you to Mel for the reminder that our ancestry, in particular its contrasts, was not just a side note, but a principal theme. Thank you to James and Ruth for their support and insights from the Bulkley Valley. Thank you to Rolf and Chris for their scathing early reviews.  Their invaluable critiques had a profound effect on our direction.  Thank you to Ani for her fathomless patience with the piles of pages and infinite coffee cups that accompanied this process.
        </p> 

        <p id="p8">Thank you to our Igorot and Wet’su’weten brothers and sisters whose examples have inspired us: James, Jed, Sir Ernesto, Jake and the Sabangan guides.</p>

        <p id="p9">Chapter banners, Eagle & Salmon No.1 and No.2, Frog and Sun by Wet’su’weten artist James Madam. </p>

        <p id="p10">Photos of Igorot culture on Earthen.io by Gladys Maxim.  Chapter 9 photos by Robert Brodey.</p>

        <p id="p11">Thank you to Thumas Hutton and Thomas Nail, both of whom wrote a book entitled <i>“A Theory of the Earth”</i>.  Although each book were published quite independently (the first in 1788 and the second in 2021!) both greatly inspired and encouraged our own work an theory.  </p>

        <p id="p12">Thank you to Mark Donnovan and Donnie Maclurcan, with whom a conversation inspired the insights of Chapter 9. </p>

        <p id="p13">Thank you to Stephen DeMeulenaere for the steamy conversations on the parrallels of capital and carbs, fats and fiat that was invaluable in shaping our ideas of Earthen energetics in <a href="energy.php">Chapter 9</a>.</p>
        
        <p id="p14">Thank you to Balaji Srinivasan. Though a good deal of our ideas are in direct opposition, the “web app” version of his book <a href="https://thenetworkstate.com" target="_blank">The Network State</a> nonetheless inspired us to aline our publishing platform and our principles and inspired our development of the Earthbook concept.</p>

        <p id="p15">Thank you to Enrique Salmon for his pioneering work developing the concept of “kincentric ecology” as a means of distinguishing Rarámuri metaphysics (and that of other fist nations) from the modern concept of 'nature'.  His work and his term underlie our use of the phrase ‘kincentric culture’ and have been invaluable to advancing our theory.</p>

        <p id="p16">Russell acknowledges the land of Banjar Sumampan, Gianyar, Indonesia, the ancestral home of the Balinese, as base for the writing and publishing of this book.</p>
        
        <p id="p17">Banayan acknowledge the land of the Igorot people and their wisdom tradition which inspired, nurtured and enabled this book, her oversight and contribution.</p>
        <div>
          

        <div id="line" style="border-style: dashed; border-width: 1px; margin-bottom: 40px; margin-top: 55px; width:100%; text-align:left;"></div>

        <div class="lead-page-paragraph" id="p18">Thank you to the open source developers and their various projects upon which the <a class="java-link" onclick="openEarthbook()" aria-label="Open About Screen" title="Learn more about what an Earthbook is"><i>Earthbook</i></a> platform is built.</div>

        <div class="page-paragraph">
        
        <p id="p20">Thank you to <a href="www.fabiodeveloper.com">Fábio Almeida</a> for his Accessibilidade CSS script which enables readers to <a class="java-link" onclick="openSettings()" aria-label="Open Settings" title="Open Accessibility Setting"><i>increase and decrease the text</i></a> of the EarthBook.</p>
        
        <p id="p21">Thank you to Zeno Rocha for his continued development of <a href="https://clipboardjs.com">ClipboardJS</a>, the elegant Javascript on our <a class="java-link" onclick="openShare()" aria-label="Open Sharing" title="Open Sharing"><i>Share page.</i></a></p>
          
        <p id="p22">Thank you to <a href="https://dewaweb.com">DewaWeb Indonesia</a> who are generously hosting this EarthBook project without charge on their Singapore servers.</p>
        
        <p id="p23">Thank you to <a href="https://www.websitecarbon.com">WebsiteCarbon </a> who enable the automated <a class="java-link" onclick="openEco()" aria-label="Open Settings" title="Open Ecological Tracking"><i>carbon impact auditing</i></a> of each Earthbook page.</p>

       
        
        <p id="p24">Thank you to Stephen for his <a href="https://commentics.com">Commentics</a> PHP code base which powers the Earthbook chapter comments.</p>
        
        <p id="p25">Thank you to Thomas Steiner for his <a href="https://github.com/GoogleChromeLabs/dark-mode-toggle">Dark Mode Toggle code</a> which powers the <a class="java-link" onclick="openSettings()" aria-label="Open Settings" title="Open Accessibility Setting"><i>Night/Day</i></a> mode swithching of the Earthbook.</p>
        </div>
