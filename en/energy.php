...
<div class="page-paragraph">
    ...
    OVER THE LAST MILLENIUM, the Wet'suwet'en people of North America's Pacific coast have lived alongside the Salmon's masterful management of energy. Observing and learning from the Salmon's example the Wet'suwet'en gained the ecological understanding and ethical inspiration to preside over the steady, millennia-long enrichment of their land. Today, we too have much to learn from them and the Salmon. As we shall see, the Salmon’s outward spiral of energy emulates the vortical pattern by which Earth itself greened the biosphere. This pattern, which underlies the ethics, traditions, and language of the Wet'suwet'en, the Igorots, and other kincentric cultures, reals the geometry of Earthen energy manager.  With the help of this second Earthen ethic we can begin to discern the inevitable pattern of depletion inherent in of our modern for-profit and not-for-profit enterprises. More importantly however, with its help, we can lay out the requisite energetic structure our enterprises must follow if they are to emulate the enriching ways of the Salmon, the Wet'suwet'en and the Igorots.</div>
