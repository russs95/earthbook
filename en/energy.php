  ...
  <div id="footer-chapter" style="margin-bottom: 0px;">
    ...
    <div id="footer-functions-box" style="width:100%; padding-top: 5px;">
      ...
      <div class="footer-function" style="cursor:pointer;" onclick="openSearch()">
        ...
        <div style="margin: auto 0px auto auto;padding-right: 7%;"><i style="background-image: url(../icons/search.svg); width:22px; height:22px;display: inline-block;background-size: 22px;margin-bottom: -3px;margin-right: 2px;"></i></div>
      </div>

      <div class="footer-function" style="cursor:pointer;" onclick="openComments()">
        <div><p style="font-variant-caps: all-petite-caps; color:grey; font-size: 1.1em; padding-left: 7%; width: 100%;">+ Chapter Reader Comments</p></div>
      ...
      <div class="footer-function" style="cursor:pointer;" onclick="openComments()">
        <div><p style="font-variant-caps: all-petite-caps; color:grey; font-size: 1.1em; padding-left: 7%; width: 100%;">+ Chapter Source Code</p></div>
      ...
      <div id="footer-icon-left" style="cursor:pointer;" onclick="openFooter()"></div>
      <div><p style="font-variant-caps: all-petite-caps; color:grey; font-size: 1.1em; padding-left: 7%; width: 100%;" >EarthBook resources</p></div>
        <div style="margin: auto 0px auto auto;padding-right: 7%;padding-left: 7%;">+</div>
      </div>
