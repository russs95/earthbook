...
dynamic transfer of energy into and out of non-­equilibrium states is what has allowed the earth to emerge, persist, and distinguish itself from other aspects of the cosmos.' Thomas Nail, A Theory of the Earth, (Standford University Press, 2021) Chap.1 p.21" onclick="openFootnotes()">⁶⁰</a></p>-->
     ...
     <p id="61-up">Just as Earth’s absorption of solar energy powered an endless procession of cycles across its surface, so too did the salmon's absorption of marine nutrients power the endless cycle of its generations.</p>
     ...
     <p id="63-up">And just as Earth’s spiraling cycles steadily greened its biosphere, so too did the salmon's relentless spiralling dispersal of nutrients contribute to the inexorble enrichment of its biome—  a common home for which countless other creatures could flourish.</p>
...
<!-- HMMMMM
     ...
     <p>As we emphasized in <i>Tracatatus Ayyew: Book One</i>, certain great green nations, ancient and ongoing, have long embodied this pattern of ecological contribution.  In particular: <a href="kincentric.php">cyclocentric cultures</a>.  As we saw, such societies are distinguished by their priority of synking with the cycles of plants and animals around them— beings whom they perceived as kindred relations.  These cultures, rather than view human endeavour as exceptional and seperate from their fellow creatures, instead understood all their enterprises to be congruent contributions to a shared system.</p>

<p>The Wetʼsuwetʼen are one such society.</p>

<p>From their view of the world, the salmon were not just kindred creatures.  They were ecological elders.</p>
...
<p>Today, as our modern enterprises strive to go green, the Wetʼsuwetʼen show us the way forward.</p>

<p>Inspired by their understanding of social and ecological energy as one and the same, we can address the humancentric assumption embedded in our modern understanding of enterprise and economy.  In particular, the view that financial energy is seperate and exceptional to Earthen planetary dynamics.  This modern economic axiom is a logical consequence of the deep rooted humancentrism that underlies the modern view of the world— an ontological foundation that, as we argued in Chapter 5,  has been long shown to be empirically faulty and scientifically fallacious.</p>
...
<p>With an updated understanding of our economies as inextricably immersed within Earth’s systems, we can see our financial energy flows anew.  In fact, our economy and enterprises are subset energy systems of the planet's biosphere, and, most significantly, are subject to the same planetary principles.</p>
    ...
    <p>Today, more and more enterprises are aware of the depleting dynamic of profit in-and-of-itself.  In order to contribute socially and environmentally, many enterprises choose a <i>‘not-for-profit’</i> energetic structure.  These enterprises strive to return their financial surpluses back to the pursuit of their social or environmental purpose. </p>
     ...
     <p>Afterall, while an enterprise may sequester much carbon and support many species— it could very well be that more carbon is emitted and more diversity depleted to achieve these short-term results! Without a systemic accounting thereof, one cannot be certain whether its net-impact is in fact a net-green contribution. 
    </p>
    ...
    <div class="footnote-section" style="z-index:8;">
      ...
      <div id="footer-reveal-container" style="height:200px;transition:0.4s;" >
       ...
       <a href="#58-up" class="footnote">   
        ...
        <div class="footnote-text">The  Wetʼsuwetʼen were not alone in this way.  Virtually all first nations of the Pacific Northwest held a concept of wealth that was defined not by what one accumulated, but of what one gave away embodied in the the 'potlacth' ceremony.  In this widespread tradition, the a community would gather to distribute gifts of all kinds.   The express purpose of these ceremonies was energetic dispersal out-to-all.   All who attended, understood well the ceremony and intention.  Within the context of the potlacth, honor and respect was gained not by the wealth itself, but by its flow, not by how much was gathered, but by how much was gifted awaollowing the example of kincentric cultures, the salmon and the Earth we must arrange the financial structure of our aspiring green enterprises accordingly.' 
        </div>
        </a>
