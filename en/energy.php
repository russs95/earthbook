...
<br><img src="https://earthen.io/content/images/2022/06/Salmon-Chart---1200px-2.png" width="100%" alt="Thomas P. Quinn, The Behavior and Ecology of Pacific Salmon and Trout, Second Edition (University of Washington Press, Seattle, 2018) Chapter 7: Carcasses. p 182: '...Research using stable isotopes has shown that the marine-derived nutrients in the salmon carcasses contribute strongly to aquatic and terrestrial ecosystems, affecting bears and other wildlife; juvenile salmon, trout, and other fishes...'"><br>
     ...
     <p>Today, <!--as we focus our efforts on reducing the ecological harm of our modern enterprises,-->as we strive to define the meaning of green for our modern homes and enterprises, it is critical to recall that humans also played a part in the flourishing of the America's continental coast over the last twelve thousand years.</p>
...
<!--
     ...
     <p>As we move on from our old view of humans as separate and exceptional to the biosphere, so too must we move on from a similar view of our enterprises and the energy that sustains them.  With an understanding of the inextricable immersion of our economies within Earth’s systems, we can see that the financial energy upon which our enterprises operate are likewise subset energy systems of the biosphere.</p>
     
     <p>Indeed, like all sub-sets of a common system (in this case the biosphere) there are numerous parralels between financial and ecological systems</p>
     
     <p>Whereas an organism manages energy in the form of proteins, fats and carbohydrates, an enterprise manages assets, capital and currency.  Whereas an organism manages its give and take of nutrients over seasonal cycles, an enterprises manages its revenues and expenses over fiscal cycles.</p>
     
     <p>Through these parralels, we can observe comparable patterns.</p>
     
     <p>Whether organism or enterprise, ecology or economy, as their cycles spin, their particular give and take of energy creates a pattern all their own.  This is observed in the inclination of their cycles to disperse energy outwards or inwards to the system that encompasses them.<a id="66-up" href="#footnotes" title="Suh, Sangwon. (2004). Materials and energy flows in industry and ecosystem networks. The International Journal of Life Cycle Assessment. 9. 335-336. 10.1007/BF02979425. Materials and energy flow analysis (MEFA) has been widely utilized in ecology and economics, occupying unique positions in both disciplines." onclick="openFootnotes()">⁶6</a></p>
