  ...
  <div id="footer-chapter" style="margin-bottom: 0px;">
    ...
    <div id="footer-functions-box" style="width:100%; padding-top: 5px;">
      ...
      <div class="footer-function" style="cursor:pointer;" onclick="openSearch()">
        <div><p style="font-variant-caps: all-petite-caps; color:grey; font-size: 1.1em">Search EarthBook</p></div>
      ...
      <div class="footer-function" style="cursor:pointer;" onclick="openComments()">
        <div><p style="font-variant-caps: all-petite-caps; color:grey; font-size: 1.1em">Chapter Reader Comments</p></div>
      ...
      <div class="footer-function" style="cursor:pointer;" onclick="openComments()">
        <div><p style="font-variant-caps: all-petite-caps; color:grey; font-size: 1.1em">Chapter Source Code</p></div>
