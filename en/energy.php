...
<br><br>
    ...
    <div class="page-paragraph">
      ...
      <div class="quote"><p id="36">“‘The world is a vampire’ as The Smashing Pumpkins sang: a vampire living from the death of the sun. The universe must die to keep living.”</p></div>
      <p style="text-align:right;font-size:1em; margin-top:-10px; margin-bottom:20px"> Thomas Nail (2021), Theory of the Earth, Standford University Press.<p>
...
Seattle, 2018) Chapter 7: Carcasses. p 182: '...Research using stable isotopes has shown that the marine-derived nutrients in the salmon carcasses contribute strongly to aquatic and terrestrial ecosystems, affecting bears and other wildlife; juvenile salmon, trout, and other fishes...'">⁶³</a></p>
     ...
     <p>All this time, nations such the Wetʼsuwetʼen, have lived side by side the salmon– and learned from them.  Seeing the salmon as ecological elders, they wove the salmon's dispersion lessons into the stories, morals and languages of their culture.</p>
<!--
     ...
     <p>In Wetʼsuwetʼen culture, this ethic of dispersion was codified in tradition.  The first Salmon caught of the season would be shared with every member of the community, meticulously ensuring that every morsel was consumed and each bone returned to the water.  Dispersion was embodied in their Carrier language. Grammatically, it is impossible to speak of 'my salmon' only of 'our salmon'.  Much as we saw in the Igorot Ayyew ethos, abundance was not measured by individual accumulation, rather by how much was given back to both people and the land.</p>
