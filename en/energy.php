...
<script src="https://unpkg.com/@popperjs/core@2.10.3/dist/esm/popper.min.js"></script>
...
function handleHighlightClick(event) {
  ...
  if (highlight) {
    highlight.classList.toggle("locked");
    if (highlight.classList.contains("locked")) {
      highlight._tippy.setContent("Tap to unhighlight");
    } else {
      highlight._tippy.setContent("Tap to highlight");
    }
  }
}
...
textNodes.forEach((node) => {
  node.addEventListener("mouseup", () => {
    ...
    if (selection.toString().length > 0) {
      ...
      // Add Tippy tooltip to highlight
      tippy(span, {
        content: "Tap to highlight",
        arrow: false,
        placement: "bottom",
        theme: "light",
        animation: "scale",
        onShow(instance) {
          instance.setContent("Tap to highlight");
        },
      });
      ...
      // Set the cursor to the end of the highlighted text
...
<br><img src="https://earthen.io/content/images/2022/06/Salmon-Chart---1200px-2.png" width="100%" alt="Thomas P. Quinn, The Behavior and Ecology of Pacific Salmon and Trout, Second Edition (University of Washington Press, Seattle, 2018) Chapter 7: Carcasses. p 182: '...Research using stable isotopes has shown that the marine-derived nutrients in the salmon carcasses contribute strongly to aquatic and terrestrial ecosystems, affecting bears and other wildlife; juvenile salmon, trout, and other fishes...'"><br>-->
     ...
     <p>Today, <!--as we focus our efforts on reducing the ecological harm of our modern enterprises,-->as we strive to define the meaning of green for our modern endeavours and enterprises, it is critical to recall that humans also played a part in the flourishing of the America's continental coast over the last twelve thousand years.  In particular, the first nations of the Pacific West Coast.</p>

     <p>Over the mellenia, nations such the Wetʼsuwetʼen have lived side by side the salmon.  Seeing the salmon as ecological elders, they were able to learn from them.  Over the generation they wove the salmon's pattern of energy management into the stories, morals and languages of their culture.</p>
<!--
     ...
     <p>In Wetsuweten culture, the very first Salmon caught each season is shared with every member of the community or family unit.  In this tradition, a morsel of the fish is meticulously distributed among each member, and every bone is respectfully returned to the water.  This dynamic is then followed in their seasonal fishing, with the community collectively catching and sharing only what is needed by each family, and surplus bones and matter returned to the river.  So ingrained is this spirit of  energetic management, that in their language grammatically it is impossible to speak of 'my salmon' only of 'our salmon'.</p>
      
     <p>This ethic, came to its social culmination in the <i>potlach</i> tradition that the Wet'suwet'en and virtually every other first nation on the Pacific coast shared: ceremonies in which food and goods that had been accumulated over a year or more were ceremoniously distributed as gifts out to all members of the community.<a id="64-up" href="#footnotes" title="'For the Gitksan and Wet'suwet'en, as for other traditional peoples, the various beliefs about the relationship of humans to the land and to the resources which sustain the people are rich and multifaceted, integrated into all aspects of society. They do not have a reductionist perspective which allows separation of the biological from the moral or mythical. Adherence to a wide variety of practices which we might separate into biological and spiritual realms is seen as necessary for the maintenance of the relationship of the people and the land with its plants and animals which sustain human life.  Conservation is interactive with ideology. As Anderson points out, it is in the realm of ideology and myth, which entrain the emotions, that the motivation to defer present gratification for the future common good is obtained. Myths or teaching stories imbue lessons on conservation, which makes possible long term sustainable adaptation, with sufficient emotional loading to make them memorable and to inspire people to put the lessons contained in them into practice.'  Leslie M. Johnson Gottesfeld (1994), Conservation, Territory, and Traditional Beliefs: An Analysis of Gitksan and Wet'suwet'en Subsistence, Northwest British Columbia, Canada. Human Ecology, p20." onclick="openFootnotes()">⁶4</a>  In the Potlach, benefit and abundance were defined by how much was given back (rather than what was accumulated).  In Banayan's Igorot culture (and many other kincentric traditions) we find a parralel ceremony of distribution in the yearly celebration of the first rice harvest: a slaughtered pig would cut up into a piece for every family of the village, which was then carried home by a representative of each on the tip of their spear.<a id="65-up" href="#footnotes" title="The Wetsuweten were not alone in this way.  Virtually all first nations of the Pacific Northwest held a concept of wealth that was defined not by what one accumulated, but of what one gave away embodied in the the 'potlach' ceremony.  In this widespread tradition, the a community would gather to distribute gifts of all kinds.   The express purpose of these ceremonies was energetic dispersal out-to-all.   All who attended, understood well the ceremony and intention.  Within the context of the potlach, honor and respect was gained not by the wealth itself, but by its flow, not by how much was gathered, but by how much was gifted awaollowing the example of kincentric cultures, the salmon and the Earth we must arrange the financial structure of our aspiring green enterprises accordingly.'" onclick="openFootnotes()">⁶⁵</a></p>


     <p>In the deep resonance of the Wet’su’weten's ways and Earth's pattern, we find our second Earth ethic.</p>
