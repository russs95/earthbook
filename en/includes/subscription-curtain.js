  ...
  connectedCallback() {
    ...
    <div class="registration-footer-holder">
        ...
        <button id="reg-down-button" onclick="sendDownRegistration()" aria-label="Hide Newsletter Registration" data-lang-id="106-hide-subscription-registration">
            <img src="../assets/svgs/down-arrow.svg" alt="Hide Earthen Newsletter registration" data-lang-id="107-hide-subscription-image-alt">
        </button>
        
          <div id="email-registration">
              <div class="registration-box">
                  <div class="reg-img">
                      <img src="../assets/svgs/subscription-side-image.svg" data-lang-id="108-subscription-image-alt-desktop" class="desktop" height="200" width="200" alt="Earthen Ecobrick Newsletter subscription">
                    <!-- <img src="../assets/svgs/richard-and-team-night.svg" data-lang-id="109-subscription-image-alt-mobile" class="mobile" height="140" width="200" alt="Earthen Ecobrick Newsletter subscription"> -->
                  </div>
                  ...
                  <div id="reg-privacy-texts">
                      ...
                      <div class="reg-privacy-subtitle" data-lang-id="117-privacy-subtitle">As a not-for-profit Earth enterprise on principle we do NOT partake in any 3rd party advertising, nor connect your data to social platforms that do.  Your data will not be sold or exchanged.  We proudly use Ghost.org's for our newsletter-- a not-for-profit open source platform which we host on our own servers.  Our newsletters are sent usually once a month, we commit to not exceeding more than one a week.</div>
                      <div style="display:flex; flex-flow:row;width:fit-content;margin:-10px 10% 0px auto;">
                          ...
                          <button class="btn" onclick="previewPrivacy()" style="height:fit-content; padding:10px 15px 10px 15px;border-radius:10px;" type="button" aria-label="Go back to registration">OK</button>                      
                      </div>
                  </div>
