...
<!--
  ...
  <div><button type="button" class="footer-settings-icon"><img src="../icons/authoring.svg" alt="Booknotes icon" style="cursor:pointer" onclick="openBooknotes()" aria-label="Click to view EarthBook Table of Contents" title="Click to view Booknotes"></button></div>
