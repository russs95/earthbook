class ContentCurtain extends HTMLElement {
  ...
  connectedCallback() {
    ...
    <a href="index.php"><img src="../icons/home.svg" alt="Home Button" style="padding-right:10px"></a> <img src="../svgs/bottom-x.svg" alt="Close Button" style="padding-left:10px"> style="cursor:pointer" onclick="closeContents()">
    </div>
        ...
        <div class="overlay-content-tc">
                    ...
                    <div class="tc-button-row">
                       ...
                       <div id="buy-btn" class="action-btn" onclick="openBookplate()" style="height: 22px;flex-grow: 1"><i style="background-image: url(../icons/about.svg); width:22px; height:22px;display: inline-block;background-size: 22px;margin-bottom: -3px;margin-right: 5px; cursor:pointer;"></i> About</div>
