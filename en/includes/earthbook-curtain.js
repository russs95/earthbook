      ...
      <div class="overlay-content-earthbook">         
            ...
            <div class="virtue-box-box">
              <div id="virtue-box-mobile">
                ...
                <div class="virtue"><img src="../assets/svgs/icon-opensource.svg" width="100%" height="100%" title="EarthBook code is fully open-source" alt="EarthBook code is fully open-source" style="cursor:pointer" onclick="openOS()"><div id="OS" class="virtue-desc">The EarthBook source code is open to review, improvement and forking <a href="https://github.com/russs95/earthbook" aria-label="Click to go to our Github repository" target="_blank">on Github</a>.  This means that publishing an Earthbook is open to anyone anywhere.</div>
                </div>

                <div class="virtue"><img src="../assets/svgs/icon-biodiversity.svg"  width="100%" height="100%" title="Supporting, Accounting & Tracking Biodiveristy" alt="Supporting, Accounting & Tracking Biodiveristy" style="cursor:pointer" onclick="openBio()"><div id="bio" class="virtue-desc">During the writing and publishing of this book, the species supported by the enterprise's physical space was tracked and accounted.  <a href="https://russs.net/forest" target="_blank" aria-label="Go to the author's home life list of supported species">See the publisher's full life list.</a></div>
                </div>

                <div class="virtue"><img src="../assets/svgs/icon-ecoaccounting.svg"  width="100%" height="100%" title="Ecological Accounting Disclosure" alt="Ecological Accounting Disclosure" style="cursor:pointer" onclick="openAcc()"><div id="acc" class="virtue-desc">Throughout the enterprise of writing and publishing of an Earthbook, the carbon, plastic and biodiversity impacts are tracked, accounted and annually disclosed.  See the <a href="accounting.php" aria-label="Click to open the PDF Regen Report for the Earthbook"> ecological accounting reports for this Earthbook.</a></div>
                </div>
              ...
              <div id="virtue-box-mobile">
                ...
                <div class="virtue"><img src="../assets/svgs/icon-for-earth.svg"  width="100%" height="100%" title="For-Earth Enterprise" alt="For-Earth Enterprise"  onclick="openForE()"><div id="fore" class="virtue-desc" style="display:block;">The medium is the message: Earthbooks are for readers, writers & Earth. Click the icons to learn about the regenerative principles that guide the project.</div>
                </div>
          ...
          <div>
            <button type="button" class="bottom-close-button" style="cursor:pointer" onclick="closeEarthbook()" aria-label="Click to close this pop-up page">
              <img src="../assets/svgs/bottom-x.svg" alt="Close page button">
            </button>
          </div>
