  ...
  <div id="bottom-earthbook" class="overlay-earthbook">
      ...
      <div class="overlay-content-earthbook">         
            ...
            <div id="virtue-box">
                ...
                <div class="virtue"><img src="../svgs/icon-biodiversity.svg"  width="100%" height="100%" title="Supporting Biodiveristy" alt="Supporting Biodiversity" style="cursor:pointer" onclick="openBio()"><div id="bio" class="virtue-desc">During the writing and publishing of this book, the species supported in the enterprise physical space was tracked and accounted for.  <a href="https://russs.net/forest" target="_blank">See the publisher's full life list.</a></div>
                </div>
