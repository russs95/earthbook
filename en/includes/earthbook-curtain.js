      ...
      <div class="overlay-content-earthbook">         
            ...
            <div class="virtue-box-box">
              <div id="virtue-box-mobile">
                ...
                <div class="virtue"><img src="../svgs/icon-opensource.svg" width="100%" height="100%" title="EarthBook code is fully open-source" alt="EarthBook code is fully open-source" style="cursor:pointer" onclick="openOS()"><div id="OS" class="virtue-desc">The EarthBook source code is open to review, improvement and forking <a href="https://github.com/russs95/earthbook">on Github</a>.  This means that publishing an Earthbook is open to anyone anywhere.</div>
                </div>

                <div class="virtue"><img src="../svgs/icon-biodiversity.svg"  width="100%" height="100%" title="Supporting, Accountin & Tracking Biodiveristy" alt="Supporting, Accountin & Tracking Biodiveristy" style="cursor:pointer" onclick="openBio()"><div id="bio" class="virtue-desc">During the writing and publishing of this book, the species supported by the enterprise's physical space was tracked and accounted.  <a href="https://russs.net/forest" target="_blank">See the publisher's full life list.</a></div>
                </div>
              ...
              <div id="virtue-box-mobile">
                ...
                <div class="virtue"><img src="../svgs/icon-carbonseq.svg"  width="100%" height="100%" title="Net-Subtractive Carbon Impact" alt="Net-Subtractive Carbon Impact"  onclick="openCo2()"><div id="co2" class="virtue-desc">Crafted from fully open and non-proprietary web protocols, an Earthbook has the lightest digital footprint compared to other eReader formats. Thanks to its byte-optimization and offline cacheability, an Earthbook's digital emissions footprint is in the top 10% of all websites.  <span style="cursor:pointer; text-decoration:underline;" onclick="openEco()">View live CO2e audit.</span></div>
                </div>
            ...
            <div id="virtue-box-mobile" style="margin-bottom:170px;">
              ...
              <div class="virtue"><img src="../svgs/icon-revenue.svg"  width="100%" height="100%" title="Support Independent Publishing" alt="Support Independent Publishing" onclick="openRev()"><div id="rev" class="virtue-desc">Earthbooks are 100% independent of corporate middlemen. 97% of the proceeds of <span style="cursor:pointer; text-decoration:underline;" onclick="openBuy()">Ebook sales</span> go to the authors.</div>
              </div>

              <div class="virtue"><img src="../svgs/icon-accessibility.svg"  width="100%" height="100%" title="Made as human-friendly as possible" alt="Accessibility Maximized"  style="cursor:pointer" onclick="openMax()"><div id="max" class="virtue-desc">Earthbooks are designed from the ground up to be easy on the eyes, accessible, and multi-lingual.  <span style="cursor:pointer; text-decoration:underline;" onclick="openSettings()">Try adjusting the Earthbook's settings.</span></div>
