  ...
  <div id="bottom-earthbook" class="overlay-earthbook">
      ...
      <div class="overlay-content-earthbook">         
            ...
            <div id="virtue-box">
                ...
                <div class="virtue" style="cursor:pointer" onclick="openForE()"><img src="../svgs/icon-for-earth.svg"  width="100%" height="100%" title="For-Earth Enterprise" alt="For-earth Enterprise"><div id="fore" class="virtue-desc">The intention and structure of this publishing enterprise is not-for-profit, for-Earth benefit.</div>
                </div>

                <div class="virtue" style="cursor:pointer" onclick="openCo2()"><img src="../svgs/icon-carbonseq.svg"  width="100%" height="100%" title="Net-Subtractive Carbon Impact" alt="Net-Subtractive Carbon Impact"><div id="co2" class="virtue-desc">Crafted from fully open and non-proprietary web protocols, an Earthbook has the lightest of all digital footprints compared to other eReader formats. Ultra-light, fast-loading, and off-line cacheable so too is its digital emissions footprint minimized.  <span style="cursor:pointer" onclick="openEco()">Live impact test.</span></div>
                </div>

                <div class="virtue" style="cursor:pointer" onclick="openCc()"><img src="../svgs/icon-creativecommons.svg"  width="100%" height="100%" title="Creative Commons" alt="Creative Commons License"><div id="cc" class="virtue-desc">The code and content of this book are licensed under a Creative Commons BY-SA-ND 4.0 License. <a href="https://github.com/russs95/earthbook/" target="_blank"> Access the Github repository.</a></div>
                </div>

                <div class="virtue" style="cursor:pointer" onclick="openFree()"><img src="../svgs/icon-readfreely.svg"  width="100%" height="100%" title="Read Freely" alt="Read Freely"><div id="free" class="virtue-desc">This book is available to read <a href="preamble.html">freely online</a> and as a <a href="https://files.earthen.io/s/ZjS9TgWk5Tr7b4q" target="_blank">free downloadable PDF</a>.</div>
                </div>
