class EcoCurtain extends HTMLElement {
  ...
  <div id="eco-curtain" class="eco-overlay">
      ...
      <div class="overlay-content-eco">         
            <div>
            <img src="../icon/eco.svg"  width="170px" height="170px" title="Ecological Accounting Kept" alt="Ecological Accounting Kept"></div>
            ...
            <div><p>Throughout the enterprise of writing and publishing an Earthbook impact, the carbon, plastic and biodiversity impacts were tracked, accounted and annually disclosed.  See the full <a href="https://files.earthen.io/s/ioobYWRRKGEpPp4" target="_blank">Regenerativity Report.</a></p></div>
            ...
            <h2><i>The Medium is the Message.</i></h2>
