...
function showFRTranslationAlert() {
  ...
  const message = `Désolé! Les versions EarthBook et EBook du Tractatus Ayyew ne sont pas encore prêtes. Cependant, vous pouvez télécharger la version PDF ici: <a href="${url}" target="_blank">${url}</a>`;
