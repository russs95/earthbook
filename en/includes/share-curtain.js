...
class ShareCurtain extends HTMLElement {
  ...
  connectedCallback() {
    ...
    <div id="right-close-button">
        <span style="cursor:pointer" onclick="closeShare()"><img src="../assets/svgs/right-x.svg" alt="Close page button"></span>
    </div>
