...
-->
    ...
    <p>As we saw in our last chapter, kincentric nations were founded on an altogether different way of knowing.  Rather than learn solely from humans, these societies recognized the plants and animals around them as kin, elders, and teachers.  Today, as we come to recognize the connection between their kincentric ontology and their pattern of ecological enrichment, we can glimpse the pattern of depletion within our own— and isolate the ontological error that distorts our modern view of the world. </p>
      ...
      <p id="48-up">Over the last decades, feminists<a href="#footnotes">⁴⁸</a>, theologians<a href="#footnotes">⁴⁹</a> and philosophers<a href="#footnotes" onclick="openFootnotes()" title="See Banayan’s work laying out a the context and definition of the Igorot Ayyew Ethos:  Banayan Angway, <i>Cordillera Administrative Region Indigenous Peoples Education Curriculum K-12</i> (Bontoc, Mountain Prov., CAR; Philippines Department of Education, 2014).">⁵⁰</a> have observed that the modern environmental ethics that results from this foundation (laws, sustainability guidelines, UN goals, etc.) are thus locked into a perspective of human-time, human-space and human-needs, and consequently: of human rights, interests and economy. From this view, ‘nature’ is inevitably objectified as something with which humanity is ever interacting: managing, dominating, stewarding. Our ‘green’ endeavors that follow, thus strive to reduce their harm, to protect and to conserve the ‘natural’ world from human touch and contamination.</p>
