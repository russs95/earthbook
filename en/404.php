...
<div id="ct-chapt-graphic" class="background-000">
    ...
    The requested page <?php echo ($name); ;?> and <?php echo var="REQUEST_URI"; ;?> couldn't be matched with any other in the EarthBook.  Check the URL for errors or mispellings.
    </div>
</div>
