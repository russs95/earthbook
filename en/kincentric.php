...
-->
    ...
    <p>While countless great greening societies have thrived around the planet, there is no more dramatic an example than the nations that first inhabited the Americas.</p>
     ...
     <p>As researchers dig deeper, further assumptions of human-absent 'bounteous nature' are being revealed as fallacy.  Areas of thick Amazon rain-forest, long seen as the paragon of Wilderness and of Nature, are now being shown to have been the site of pre-Columbian agriculture, gardens, towns and cities.<a href="#footnotes">⁴⁰</a></p>

     <p id="41">While these first nations manifested vastly different variations of culture across the continents, nonetheless, they shared certain philosophical fundamentals in common<a href="#footnotes">⁴¹</a>.  In particular, in contrast to the vastly different world view of the arriving Europeans explorers<a href="#footnotes">⁴²</a>.</p>
