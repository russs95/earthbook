         ...
         if ( xmlhttp.readyState === 4 && xmlhttp.status === 200 ) {  
             ...
             try{  
                ...
                for( var i = 0; i < outputPosts.length; i++ ){  
                 ...
                 resultsContainer.innerHTML += "<div class=\"tc-item\"><div id='result_" + i + "' style=\"display:flex; text-align:left; padding: 23px;\"><div class=\"chapter_pic\" style=\"width=100px; margin-right:10px;\"><img src=\"" + outputPosts[ i ].image_url + "\" width=\"100px\" height=\"100px\"></div><div class=\"chapter-name-search\"><span style=\"font-size:small, color:grey;\"><b style=\"font-size:larger;\"><a href='" + outputPosts[ i ].url + "'>" + outputPosts[ i ].title + "</b><br>" + outputPosts[ i ].chapter + "  |  " + outputPosts[ i ].book + "  |  Words: " + outputPosts[ i ].words + "  |  " + outputPosts[ i ].language + "<br><span style=\"font-size:medium;\">" + outputPosts[ i ].chap_description + "</span><br><span style=\"font-size:smaller;\">" + outputPosts[ i ].url + "</span></a></div>;";  
             }  
