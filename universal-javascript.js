    ...
    if (this.readyState == 4 && this.status == 200) {
      ...
      if (outputPosts.length == 0) {
        ...
        for (var i = 0; i < outputPosts.length; i++) {
          resultsContainer.innerHTML += "<div class=\"tc-item\"><div id='result_" + i + "' style=\"display:flex; text-align:left; padding: 20px;\"><div class=\"chapter_pic\" style=\"width=100px; margin-right:10px;display:block;\"><img src=\"" + outputPosts[i].image_url + "\" width=\"100px\" height=\"100px\"></div><div class=\"chapter-name-search\"><b style=\"font-size:larger;margin-bottom:10px;display:block;\"><a href='" + outputPosts[i].url + "'>" + outputPosts[i].title + "</b><span style=\"font-size:smaller;color:var(--drop-cap)!important;margin-top:10px;display:block;\">" + outputPosts[i].chapter + "  |  " + outputPosts[i].book + "  |  " + outputPosts[i].words + " words  |  " + outputPosts[i].language + "</span><br><span style=\"font-size:medium;font-family:'CooperLt',serif;margin-top:0px;display:block;\">" + outputPosts[i].chap_description + "</span><span style=\"font-size:smaller;color:grey;margin-top:10px;display:block;\">" + outputPosts[i].url + "</span></a></div>";
        }
      }
    }
  };
