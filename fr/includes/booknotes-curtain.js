...
<div class="overlay-content-tc" style="min-height:80%;">
    ...
    <div id="book-notes-list">
        ...
        <div style="margin:auto;">
            <button id="reset-settings-bn" onclick="resetBookNotes()" style="width: 200px;margin: 30px auto 20px auto; cursor:pointer; padding:7px;font-size: medium;">No Booknotes Saved</button>
...
<div id="bookNotePalette" class="palette-hidden">
   <div class="main-pallette-buttons" id="palletteBar">
        <div  class="highlight-buttons">
            ...
            <button class="color-btn" style="background:green" data-color="green" aria-label="Highlight Text Green" title="Highlight & Save Green"></button>
<button class="color-btn" style="background:red" data-color="red" aria-label="Highlight Text Red" title="Highlight & Save Red"></button>
<button class="color-btn" style="background:#2daee5" data-color="#2daee5" aria-label="Highlight Text Blue" title="Highlight & Save Blue"></button>
    ...
    <button id="annotate-button" style="padding: 8px 15px;cursor:pointer;margin-right:8px;font-size:medium;" onclick="appendAnnotation()">Annotate</button>
    <button id="annotate-cancel" style="padding: 8px 15px;cursor:pointer;font-size:medium;"  onclick="cancelAnnotation()">Cancel</button>
    </div>
</div>
