class TourCurtain extends HTMLElement {
  ...
  <div class="tour-content">
    ...
    <div class="tour-image"><img src="../assets/svgs/earthbook.svg" title="Lire librement" alt="Bienvenue dans un Earthbook"></div>  
    ...
    <div class="tour-image"><img src="../assets/svgs/icon-accessibility.svg"  style="margin:auto" title="Convivialité pour les humains" alt="Lire librement"></div>  
    ...
    <div class="tour-image"><img src="../assets/svgs/icon-ecoaccounting.svg"    title="Respectueux de la planète" alt="Lire librement"></div>  
    ...
    <div class="tour-image"><img src="../assets/svgs/icon-opensource.svg" title="Lire librement" alt="Lire librement"></div>  
    ...
    <div class="tour-image"><img src="../assets/svgs/shareable.svg" title="Outils de lecture" alt="Lire librement"></div>  
    ...
    <div class="tour-image"><img src="../assets/svgs/icon-revenue.svg"  title="Acheter l'eBook" alt="Acheter l'eBook"></div>  
