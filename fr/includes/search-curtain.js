      ...
      <div class="search-overlay-content">
        ...
        <div class="search-box" style="padding-bottom:15%;">
          <div class="copy-section">
            ...
            <button class="btn" style="padding:22px 0px 22px 0px;" onclick="EarthbookSearch(['glossary.json', 'chapters-index.json'])" aria-label="Bouton de recherche"><i style="background-image: url(../assets/icons/search-white.svg); width:22px; height:22px;display: inline-block;background-size: 22px;margin-bottom: -3px;margin-right: 2px;"></i></button> 
          </div>  
