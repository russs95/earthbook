class EcoCurtain extends HTMLElement {
  ...
  connectedCallback() {
    ...
    <div class="overlay-content-eco">
      ...
      <div class="eco-header">Le format Earthbook est codé à la main de A à Z pour être vert.</div>
 
      <div class="eco-text">
      Dans la rédaction et la publication d'un Earthbook, ses impacts sur le carbone, le plastique et la biodiversité sont suivis, comptabilisés et divulgués. Consultez le <a href="https://files.earthen.io/s/ioobYWRRKGEpPp4" target="_blank" aria-label="Le rapport Regen pour notre livre">Rapport sur la régénérativité</a> de cet Earthbook.
      </div>
 
      <a href="https://files.earthen.io/s/ioobYWRRKGEpPp4" target="_blank" aria-label="Le rapport Regen pour notre livre">
      <div><img src="../assets/banners/forearth-dark-350px.png" alt="Bannière déclarant notre intention For-Earth" style="width:300px;"></div></a>
 
       <div id="wcb" class="carbonbadge wcb-d"></div>
 
      <div class="eco-medium">Le média est le message.</div>
