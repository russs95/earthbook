class footSettings extends HTMLElement {
  ...
  <div class="footer-size" style="height:30px;">
      ...
      <div><button type="button" class="footer-settings-icon" style="cursor:pointer; text-align:left; width:fit-content;flex-grow:1; padding-right:8px; padding-top: 10px;padding-bottom: 0px;" onclick="openEarthbook()" aria-label="Découvrez ce qu'est un Earthbook">Qu'est-ce que c'est un Earthbook?</button>
      </div>
