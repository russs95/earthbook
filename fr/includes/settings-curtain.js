class SettingsCurtain extends HTMLElement {
    ...
    connectedCallback() {
      ...
      <div id="left-close-button">
              <span style="cursor:pointer" onclick="closeSettings()" aria-label="Cliquez pour fermer la page des paramètres"><img src="../assets/svgs/left-x.svg" alt="Bouton de fermeture des paramètres"></span>
          </div>
