class Header extends HTMLElement {
  ...
  connectedCallback() {
    ...
    <div id="settings-menu">
        <button type="button" style="cursor:pointer; background:none;border:none;" onclick="openSettings()" aria-label="Ouvrir les paramètres"><img src="../assets/svgs/left-menu.svg" alt="Icône des paramètres"></button>
    </div>
    ...
    <div id="share-menu">
        <button type="button" style="cursor:pointer; background:none;border:none;" onclick="updateBNResetButton(),openBooknotes(), bookNotesCreator()" aria-label="Open Booknotes Link"><img src="../assets/icons/booknotes-topmenu.svg" alt="Share icon"></button>
        </div>
</div>
