class footSettings extends HTMLElement {
    ...
    connectedCallback() {
      ...
      <!--
        ...
        <!--<div style=""><button type="button" class="footer-settings-icon"><img src="../assets/svgs/to-the-top-arrow.svg" alt="To the top of page" style="cursor:pointer" onclick="location.href='#top'" aria-label="Go to top of page"></button></div>-->
