...
var z = document.getElementById("footnotes-concealer");
  ...
  y.style.background = "url(../assets/icons/up-arrow.svg) no-repeat center";
...
if (x.style.height === "200px") {
  ...
  y.style.background = "url(../assets/icons/down-arrow.svg) no-repeat center";
  y.style.backgroundSize = "contain";
  z.style.opacity = "1";
}
}
...
if (x.style.marginBottom === "0px") {
 ...
 z.style.background = "url(../assets/icons/up-arrow.svg) no-repeat center";
z.style.backgroundSize = "contain";

} else {
  x.style.marginBottom = "0px";
z.style.background = "url(../assets/icons/down-arrow.svg) no-repeat center";
z.style.backgroundSize = "contain";
