...
<?php require_once ("en/includes/eco-curtain.php");?>
...
<div id="footer-chapter" style="margin-bottom: 0px;">
  ...
  <div class="footer-size">
    ...
    <div class="footer-right">
      ...
      <a href="en/preamble.php"><div class="next-button">Preamble ➔</div></a>

    </div>
  </div>
</div>

<?php require_once ("en/includes/chap-footer.php");?>
